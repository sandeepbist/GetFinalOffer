  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-lg border bg-transparent px-3 py-2 text-sm whitespace-nowrap",
        "shadow-xs outline-none focus-visible:ring-[3px]",
        "transition-[transform,color,box-shadow,border-color,background-color] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)]",
        "active:scale-[0.98]",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "shadow-[0_20px_50px_-38px_var(--shadow)]",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "relative flex w-full items-center gap-2 rounded-lg py-2 pr-8 pl-2.5 text-sm",
