...
export const SearchMetadataSchema = z.object({
    ...
    graphLatencyMs: z.number().optional(),
    graphFallbackUsed: z.boolean().optional(),
    expandedSkillCount: z.number().optional(),
    graphNewCandidatesFound: z.number().optional(),
    graphSeedCount: z.number().optional(),
    graphStrictMatchRows: z.number().optional(),
    graphContainsFallbackUsed: z.boolean().optional(),
    graphContainsMatchRows: z.number().optional(),
    blendVariant: z.string().optional(),
    filters: z.object({
