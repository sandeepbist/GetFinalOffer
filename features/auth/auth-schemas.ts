...
export const gfoUserTable = pgTable("gfo_user", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => createId()),
...
export const gfoSessionTable = pgTable("gfo_session", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => createId()),
  userId: text("user_id")
...
export const gfoAccountTable = pgTable("gfo_account", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => createId()),
  userId: text("user_id")
...
export const gfoVerificationTable = pgTable("gfo_verification", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => createId()),
